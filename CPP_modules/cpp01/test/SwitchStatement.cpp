...
int main()
{
	...
	// SwitchStatement.cpp:35:13: warning: no case matching constant switch condition '2'
    // std::cout << '\n';
	...
	// SwitchStatement.cpp:86:13: warning: no case matching constant switch condition '0'
    // switch (0)
