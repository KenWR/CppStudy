...
AAnimal::AAnimal(const AAnimal &copy) : type_(copy.type_) {
  std::cout << "\033[33mAAnimal copy constructor works done\033[0m"
            << std::endl;
}

AAnimal &AAnimal::operator=(const AAnimal &src) {
  std::cout << "\033[33mAAnimal assignment operator works done\033[0m"
            << std::endl;
...
void AAnimal::makeSound() const { std::cout << "Grrrr..." << std::endl; }
